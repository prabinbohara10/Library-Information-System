...
public class c_Librarian_login extends Application {
	...
	@FXML 
     public void checking_user_pass() throws SQLException, IOException {
		    ...
		    String sql="Select * from table_user_pass Where username='"+username_field.getText()+"' and password ='"+password_field.getText()+"'";                  
